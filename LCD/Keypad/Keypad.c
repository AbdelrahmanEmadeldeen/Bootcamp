...
void Keypad_init(void){
	...
	DIO_SetPinDirection(KEYPAD_COL1,0);
	DIO_SetPinDirection(KEYPAD_COL2,0);
	DIO_SetPinDirection(KEYPAD_COL3,0);
	DIO_WritePin(KEYPAD_COL1,1);
	DIO_WritePin(KEYPAD_COL2,1);
	DIO_WritePin(KEYPAD_COL3,1);

	DIO_SetPinDirection(KEYPAD_RAW1,1);
	DIO_SetPinDirection(KEYPAD_RAW2,1);
	DIO_SetPinDirection(KEYPAD_RAW3,1);
